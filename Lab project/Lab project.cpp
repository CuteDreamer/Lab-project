...
// <param names> принимаем двухмерный массив и его размеры </param names>
{
    ...
    while (gifts < 50) {
        ...
        if (map[x][y] != '#' && map[x][y] != 'OOO' && x < HEIGHT - 1 && y < WIDTH - 1 && x > 0 && y > 0) {    // тут проверка на размещение гифтов, чтобы они в стенах не генерились
            map[x][y] = '7';
            gifts++;
        }
    }
...
{                                                                             // <param names> координаты игрока по х , у и две строки, которыми отрисовывается персонаж </param names>
...
void move_down(char map[][107], int& playerX, int& playerY, const string& player1, const string& player2)    // <summary> Функция отвечает за движение вниз </summary>                                                                                                          
...
void move_up(char map[][107], int& playerX, int& playerY, const string& player1, const string& player2)      // <summary> Функция отвечает за движение вверх </summary>
{                                                                                                            // <param names> передаём массив, передаём оригиналы координат х и у, передаём персонажа </param names>
...
void move_left(char map[][107], int& playerX, int& playerY, const string& player1, const string& player2)     // <summary> Функция отвечает за движение влево </summary>
{                                                                                                             // <param names> передаём массив, передаём оригиналы координат х и у, передаём персонажа </param names>
...
void move_right(char map[][107], int& playerX, int& playerY, const string& player1, const string& player2)    // <summary> Функция отвечает за движение вправо </summary>
{                                                                                                             // <param names> передаём массив, передаём оригиналы координат х и у, передаём персонажа </param names>
    ...
    while (true) {
        ...
        if (_kbhit()) {
            ...
            if (direct == direction::DOWN) {
                ...
                move_down(map, playerX, playerY, player1, player2);
            }
            else if (direct == direction::UP) {

                move_up(map, playerX, playerY, player1, player2);
            }
            else if (direct == direction::LEFT) {

                move_left(map, playerX, playerY, player1, player2);
            }
            else if (direct == direction::RIGHT) {

                move_right(map, playerX, playerY, player1, player2);
